;(function () {
  ...
  if (url && url.length > 1) {
    ...
    url = window.__REDOC_DEV__
      ? url
      : '\\\\cors.apis.guru/' + url;
    document
      .getElementsByTagName('redoc')[0]
      .setAttribute('spec-url', url);
  }
  ...
  specs.addEventListener('dom-change', function () {
    ...
    specs.specs = ['https://api.apis.guru/v2/specs/instagram.com/1.0.0/swagger.yaml', 'https://api.apis.guru/v2/specs/googleapis.com/calendar/v3/swagger.yaml', 'https://api.apis.guru/v2/specs/data2crm.com/1/swagger.yaml', 'https://api.apis.guru/v2/specs/graphhopper.com/1.0/swagger.yaml'];
